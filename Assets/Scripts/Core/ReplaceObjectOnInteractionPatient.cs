...
public class ReplaceObjectOnInteractionPatient : BaseGameObject
{
    [field: SerializeField]
    public SickPerson SickPerson { get; private set; }

    [field: SerializeField]
    public string MedicalErrorIfCure { get; private set; }
    ...
    private void OnInteractionButtonPressed(PlayerInteraction interaction)
    {
        ...
        if (SickPerson.Disease != null && SickPerson.Disease.Definition.Cure == MedicalErrorIfCure)
        {
            SickPerson.CauseMedicalError();
